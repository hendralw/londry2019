                                ...
                                <div class="card-block">
                                    <div class="row m-b-25">
                                        <div class="col-auto p-r-0">
                                            <div class="u-img">
                                                <img src="{{ asset ('files/assets/images/breadcrumb-bg.jpg') }}" alt="user image" class="img-radius cover-img">
                                                <img src="{{ asset ('files/assets/images/avatar-2.jpg') }}" alt="user image" class="img-radius profile-img">
                                            </div>
                                        </div>
                                        <div class="col">
                                        ...
                                        <div class="card-block">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <h6 class="text-muted f-w-400"><a href="https://colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="056f606b7c456268646c692b666a68">[email&#160;protected]</a>
                                                    </h6>
                                                </div>
                                                <div class="col-sm-6">
...
<script type="a6981f219beb88a97adf84b7-text/javascript" src="{{ asset ('files/bower_components/jquery/js/jquery.min.js') }}"></script>
<script type="a6981f219beb88a97adf84b7-text/javascript" src="{{ asset ('files/bower_components/jquery-ui/js/jquery-ui.min.js') }}"></script>
<script type="a6981f219beb88a97adf84b7-text/javascript" src="{{ asset ('files/bower_components/popper.js/js/popper.min.js') }}"></script>
<script type="a6981f219beb88a97adf84b7-text/javascript" src="{{ asset ('files/bower_components/bootstrap/js/bootstrap.min.js') }}"></script>

<script type="a6981f219beb88a97adf84b7-text/javascript" src="{{ asset ('files/bower_components/jquery-slimscroll/js/jquery.slimscroll.js') }}"></script>

<script type="a6981f219beb88a97adf84b7-text/javascript" src="{{ asset ('files/bower_components/modernizr/js/modernizr.js') }}"></script>

<script type="a6981f219beb88a97adf84b7-text/javascript" src="{{ asset ('files/bower_components/chart.js/js/Chart.js') }}"></script>

<script src="{{ asset ('files/assets/pages/widget/amchart/amcharts.js') }}" type="a6981f219beb88a97adf84b7-text/javascript"></script>
<script src="{{ asset ('files/assets/pages/widget/amchart/serial.js') }}" type="a6981f219beb88a97adf84b7-text/javascript"></script>
<script src="{{ asset ('files/assets/pages/widget/amchart/light.js') }}" type="a6981f219beb88a97adf84b7-text/javascript"></script>
<script src="{{ asset ('files/assets/js/jquery.mCustomScrollbar.concat.min.js') }}" type="a6981f219beb88a97adf84b7-text/javascript"></script>
<script type="a6981f219beb88a97adf84b7-text/javascript" src="{{ asset ('files/assets/js/SmoothScroll.js') }}">
</script>
<script src="{{ asset ('files/assets/js/pcoded.min.js') }}" type="a6981f219beb88a97adf84b7-text/javascript">
</script>

<script src="{{ asset ('files/assets/js/vartical-layout.min.js') }}" type="a6981f219beb88a97adf84b7-text/javascript">
</script>
<script type="a6981f219beb88a97adf84b7-text/javascript" src="{{ asset ('files/assets/pages/dashboard/custom-dashboard.js') }}"></script>
<script type="a6981f219beb88a97adf84b7-text/javascript" src="{{ asset ('files/assets/js/script.min.js') }}">
</script>

<script async src="https://www.googletagmanager.com/gtag/js?id=UA-23581568-13" type="a6981f219beb88a97adf84b7-text/javascript"></script>
<script type="a6981f219beb88a97adf84b7-text/javascript">
...
<script src="{{ asset ('ajax.cloudflare.com/cdn-cgi/scripts/95c75768/cloudflare-static/rocket-loader.min.js') }}" data-cf-settings="a6981f219beb88a97adf84b7-|49" defer=""></script>

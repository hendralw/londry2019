                            ...
                            <div class="card">
                                <div class="card-block">
                                    <div class="dt-responsive table-responsive">
                                        <table id="new-cons" class="table table-striped table-bordered nowrap" data-form="deleteForm">
                                            <thead>
                                                <tr>
                                                    <th width=30px>No</th>
                                                    <th>Name</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('Customer.edit', $customer->customers_id) }}" data-toggle="modal" data-target="#editmodal" id="customers_id" data-id="{{ $customer->customers_id }}" data-name="{{ $customer->customers_name }}" data-address="{{ $customer->customers_address }}" data-phone="{{ $customer->customers_phone }}"><i class="fa fa-pencil btn btn-warning btn-mini btn-round"></i>
                                                        </a>

                                                        <a href="{{ route('Customer.destroy', $customer->customers_id) }}" data-toggle="modal" data-target="#deletemodal" id="customers_id" data-id="{{ $customer->customers_id }}"><i class="fa fa-trash-o btn btn-danger btn-mini btn-round"></i></a>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="page-body">
                                {{ Form::open(array('route' => 'Customer.store', 'method' => 'POST', 'id' => 'addForm')) }}
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="number" class="form-control" id="customers_phone" name="customers_phone">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="page-body">
                                @if(count($customers))
                                {{ Form::model($customers, ['method' => 'PATCH', 'route' => ['Customer.update', $customer->customers_id], 'id' => 'editForm']) }}
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group row" hidden>
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="customers_id" id="customers_id_edit">
                                                <span class="messages"></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="customers_name" id="customers_name_edit">
                                                <span class="messages"></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Address</label>
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="customers_address" id="customers_address_edit">
                                                <span class="messages"></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="number" class="form-control" name="customers_phone" id="customers_phone_edit">
                                                <span class="messages"></span>
                                            </div>
                                        </div>
                                        <div class="form-group row f-right">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="page-body">
                                @if(count($customers))
                                {{ Form::model($customers, ['method' => 'Delete', 'route' => ['Customer.destroy', $customer->customers_id]]) }}
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group row" hidden>
                                            <label class="col-sm-12 col-form-label">Id
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="customers_id" id="customers_id_delete">
                                                <span class="messages"></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
        ...
        $("#addForm").validate({
            ...
            messages: {
                ...
                customers_phone: {
                    ...
                    minlength: "Phone number must consist of at least 2 digits"
                },
            },
            errorElement: "em",
...
<script type="text/javascript">
    $('#editmodal').on('show.bs.modal', function(e) {
        ...
        var customers_id_edit = a.data('id');
        var customers_name_edit = a.data('name');
        var customers_address_edit = a.data('address');
        var customers_phone_edit = a.data('phone');
        var modal = $(this)
        document.getElementById("customers_id_edit").value = customers_id_edit;
        document.getElementById("customers_name_edit").value = customers_name_edit;
        document.getElementById("customers_address_edit").value = customers_address_edit;
        document.getElementById("customers_phone_edit").value = customers_phone_edit;
    })
</script>
...
<script type="text/javascript">
    $('#deletemodal').on('show.bs.modal', function(e) {
        var a = $(e.relatedTarget);
        var customers_id_delete = a.data('id');
        var modal = $(this)
        document.getElementById("customers_id_delete").value = customers_id_delete;
    })
</script>

                                        ...
                                        <table id="new-cons" class="table table-striped table-bordered nowrap"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('Customer.edit', $customer->customers_id) }}"
                                                            data-toggle="modal" data-target="#editmodal"
                                                            id="customers_id" data-id="{{ $customer->customers_id }}"
                                                            data-name="{{ $customer->customers_name }}"
                                                            data-address="{{ $customer->customers_address }}"
                                                            data-phone="{{ $customer->customers_phone }}"><i
                                                                class="fa fa-pencil btn btn-warning btn-mini btn-round"></i>
                                                        </a>

                                                        <a href="{{ route('Customer.destroy', $customer->customers_id) }}"
                                                            data-toggle="modal" data-target="#deletemodal"
                                                            id="customers_id" data-id="{{ $customer->customers_id }}"><i
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="customers_address"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="number" class="form-control" id="customers_phone"
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="number" class="form-control" name="customers_phone"
                                                    id="customers_phone_edit">
                                                <span class="messages"></span>
                                            </div>
                                        </div>
                                        <div class="form-group row f-right">

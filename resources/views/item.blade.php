                                        ...
                                        <table id="new-cons" class="table table-striped table-bordered nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('List_Item.edit', $list_item->list_items_id) }}" data-toggle="modal" data-target="#editmodal" id="list_items_id" data-category="{{ $list_item->item_category->item_categories_name }}" data-unit="{{ $list_item->unit_items_id }}" data-duration="{{ $list_item->duration->durations_name }}" data-name="{{ $list_item->list_items_name }}" data-price="{{ $list_item->list_items_price }}"><i class="fa fa-pencil btn btn-warning btn-mini btn-round"></i></a>

                                                        <a href="{{ route('List_Item.destroy', $list_item->list_items_id) }}" data-toggle="modal" data-target="#deletemodal" id="list_items_id"><i class="fa fa-trash-o btn btn-danger btn-mini btn-round"></i></a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="list_items_name" id="list_items_name">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="number" class="form-control" id="list_items_price" name="list_items_price">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" name="list_items_address" id="list_items_address_edit">
                            <span class="messages"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <input type="number" class="form-control" name="list_items_phone" id="list_items_phone_edit">
                            <span class="messages"></span>
                        </div>
                    </div>
                    <div class="form-group row f-right">
